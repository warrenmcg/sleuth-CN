...
3. Modeling to detect differences between conditions of interest
...
sleuth analysis: `null_model` to provide a null model to compare for a likelihood ratio test using `sleuth_lrt`
